...
- [Funções/procedimentos aninhados](#nested)
	...
	- [Cenário Realista](#Cenário-Realista)
		- [Sintese de Teoria dos Grafos](#Sintese-de-Teoria-dos-Grafos)
		- [Código do Programa](#Código-do-Programa)
		- [Explicação de partes do código](#Explicação-de-partes-do-código)
			- [Grafos Especiais](#Grafos-Especiais)
			- [Clique e Conjunto Independente](#Clique-e-Conjunto-Independente)
			- [Isomorfismo](#Isomorfismo)
			- [Coloração](#Coloração)
			- [Grafo Hamiltoniano](#Grafo-Hamiltoniano)
			- [Conclusão](#Conclusão)
- [Exemplos](#Exemplos)
